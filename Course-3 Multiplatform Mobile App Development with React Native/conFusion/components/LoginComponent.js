...
class RegisterTab extends Component {
    ...
    const LoginPage = createBottomTabNavigator();

    function LoginScreen() {
        return (
          <LoginPage.Navigator initialRouteName="LoginTab" tabBarOptions={{
            activeBackgroundColor: '#9575CD',
            inactiveBackgroundColor: '#D1C4E9',
            activeTintColor: '#ffffff',
            inactiveTintColor: 'gray'
        }}>
            <LoginPage.Screen name="Login" component={LoginTab}  options={{ tabBarIcon: ({ color, size }) => (
             <Icon  name='sign-in' type='font-awesome' size={size} color={color} />  ), }}
             />
            <LoginPage.Screen name="Register" component={RegisterTab} options={{ tabBarIcon: ({ color, size }) => (
